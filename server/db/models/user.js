...
const UserSchema = new mongoose.Schema({
  ...
  */
  organization: { type: mongoose.Schema.Types.ObjectId, ref: 'Organization', autopopulate: true },
  reviews: [{ type: mongoose.Schema.Types.ObjectId, ref: 'Review' }],
  experience: [{ type: mongoose.Schema.Types.ObjectId, ref: 'Program' }],
  // TODO: Schema for internship application tracking
  /*
    ...
    if (err) {
      ...
      for (let i = 0; i < min; i++) {
        fakes[i] = new User({
          ...
          organization: ids.organization[i],
          reviews: [
            ids.review[i],
            ids.review[i]
          ],
